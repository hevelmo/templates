...
include_once 'suk_con_ini.php';
include_once 'queryintojson.php';

function getConnectionCamcar() {
    $dbhost = CAMHOST;
    $dbname = CAMDATABASE;
    $dbh = new PDO("mysql:host=$dbhost;dbname=$dbname", CAMUSER, CAMPASSWORD, array(PDO::MYSQL_ATTR_INIT_COMMAND => "SET NAMES utf8"));
    $dbh->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
    return $dbh;
}
function getConnectionSuzuki() {
    $dbhost = SUKHOST;
    $dbname = SUKDATABASE;
    $dbh = new PDO("mysql:host=$dbhost;dbname=$dbname", SUKUSER, SUKPASSWORD, array(PDO::MYSQL_ATTR_INIT_COMMAND => "SET NAMES utf8"));
    $dbh->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
    return $dbh;
}
