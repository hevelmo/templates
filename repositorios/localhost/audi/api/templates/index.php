                            ...
                            <tr>
                                <td width="100%" valign="middle" align="center" class="logo">
                                    ...
                                    <table width="540" border="0" cellpadding="0" cellspacing="0" align="center" style="text-align: center; border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" class="fullCenter2">
                                        ...
                                        <tr>
                                            <td width="100%"><span><img src="{{ con_dex_url }}{{ con_dex_logo }}" alt=""></span></td>
                                        </tr>
                                        <tr>
                                            <td width="100%" height="30"></td>
                                        </tr>
                                                ...
                                                <!--[if !mso]><!--><span style="font-family: Helvetica; font-weight: normal;"><!--<![endif]-->
                                                    ...
                                                    <ol type="1">
                                                        ...
                                                        <li style="list-style-type: disc;">
                                                            <b>Camión de interés.</b>
                                                            <ul>
                                                                <li>
                                                                     <i>{{ con_dex_name }} {{ con_dex_lastname }}</i>
                                                                </li>
                                                            </ul>
                                                        </li>
                                                        <li style="list-style-type: disc;">
                                                    ...
                                                    <tr>
                                                        <td align="center" height="45" bgcolor="#000" style="border-top-left-radius: 0px; border-top-right-radius: 0px; border-bottom-right-radius: 0px; border-bottom-left-radius: 0px; padding-left: 30px; padding-right: 30px; font-weight: bold; font-family: Helvetica, Arial, sans-serif; color: rgba(255, 255, 255, 0.9); background-color: #000;">
                                                            ...
                                                            <span style="font-family: Helvetica; font-weight: normal;"><!--<![endif]-->
                                                                <a href="mailto:{{ con_dex_email }}?subject=Información general" style="color: rgba(255, 255, 255, 0.9); font-size: 15px; text-decoration: none; line-height: 34px; width: 100%;">Responder a {{ con_dex_name }} {{ con_dex_lastname }}</a>
                                                                <br>
                                                            <!--[if !mso]><!--></span><!--<![endif]-->
                                                        </td>
                                                    </tr>
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0" align="left" width="100%">
                                                    <tr>
                                                        <td align="center" height="45" bgcolor="#000" style="border-top-left-radius: 0px; border-top-right-radius: 0px; border-bottom-right-radius: 0px; border-bottom-left-radius: 0px; padding-left: 30px; padding-right: 30px; font-weight: bold; font-family: Helvetica, Arial, sans-serif; color: rgba(255, 255, 255, 0.9); background-color: #000;">
                                                            <!--[if !mso]><!-->
                                                            <span style="font-family: Helvetica; font-weight: normal;"><!--<![endif]-->
                                                                <a href="mailto:{{ con_dex_email }}?subject=Información general" style="color: rgba(255, 255, 255, 0.9); font-size: 15px; text-decoration: none; line-height: 34px; width: 100%;">Gestiona todos tus prospectos en Click To Lead</a>
                                                                <br>
                                                            <!--[if !mso]><!--></span><!--<![endif]-->
                                                        </td>
                                                    </tr>
                        ...
                        <table width="600" border="0" cellpadding="0" cellspacing="0" align="center" class="mobile2" object="drag-module-small">
                            <tr>
                                <td valign="middle" width="100%" style="text-align: left; font-family: Helvetica, Arial, sans-serif; font-size: 13px; color: rgba(255, 255, 255, 0.9); line-height: 24px; text-align: center">
                                    <!--[if !mso]><!--><span style="font-family: Helvetica; font-weight: normal;"><!--<![endif]-->&copy; 2016 {{ con_dex_concessionary }} <!--<![endif]--></span><!--[if !mso]><!-->
                                </td>
                            </tr>
                        </table>
