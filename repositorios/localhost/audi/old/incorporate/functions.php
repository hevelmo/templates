...
//include_once 'ldr_con_ini.php';
include_once 'queryintojson.php';

function getConnection_cam() {
    $dbhost = HOST;
    $dbname = DATABASE;
...
function getConnection_ldr() {
    $dbhost = HOST2;
    $dbname = DATABASE2;
    $dbh = new PDO("mysql:host=$dbhost;dbname=$dbname", USER2, PASSWORD2, array(PDO::MYSQL_ATTR_INIT_COMMAND => "SET NAMES utf8"));
    $dbh->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
    return $dbh;
}
