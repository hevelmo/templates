...
<head>
<title>Mouseover zoom vertical gallery</title>
...
<meta property="og:image" content="http://www.ajax-zoom.com/pic/layout/image-zoom_32_clean_vertical.jpg"/> 
...
include ('navi.php');
?>
<h2 style="padding-left: 20px;">Clean example: responsive jQuery Mouseover Zoom with vertical gallery</h2>
<div style="padding: 10px 0px 0px 20px">
	<!-- Wrapper for media, this HTML is all you need -->
	<div style="float: left; position: relative; width: 352px; height: 380px; margin: 0px 20px 20px 0px">
		
		<!-- gallery with thumbs (will be filled with thumbs by javascript) -->
		<!--<div id="az_mouseOverZoomGallery" style="position: absolute; width: 252px; bottom: 0px; display: none;"> -->
		<div id="az_mouseOverZoomGallery" style="position: absolute; left: 0; width: 82px; height: 380px; display: none;">
			Gellery loading...
		</div> 
		
		<!-- Container for mouse over image -->
		<div id="az_mouseOverZoomContainer" style="position: absolute; left: 100px; width: 250px; height: 375px; background-color: #FFFFFF; border: #AAA 1px solid">
