...
! function(ba) {
    ...
    function U(e, i, n, r) {
        return i && A(i, function(i, o) {
            !n && t(e, o) || (!r || "object" != typeof i || !i || H(i) || G(i) || i instanceof RegExp ? e[o] = i : (e[o] || (e[o] = {}), U(e[o], i, n, r)))
        }), e
    }
    ...
    function ga(i) {
        function r(e, t, i) {
            var r, o, a, s, u, d, c, f, t = t && t.split("/"),
                p = D.map,
                l = p && p["*"];
            if (e) {
                for (e = e.split("/"), o = e.length - 1, D.nodeIdCompat && Q.test(e[o]) && (e[o] = e[o].replace(Q, "")), "." === e[0].charAt(0) && t && (o = t.slice(0, t.length - 1), e = o.concat(e)), o = e, a = 0; a < o.length; a++) s = o[a], "." === s ? (o.splice(a, 1), a -= 1) : ".." === s && 0 !== a && (1 !== a || ".." !== o[2]) && ".." !== o[a - 1] && a > 0 && (o.splice(a - 1, 2), a -= 2);
                e = e.join("/")
            }
            if (i && p && (t || l)) {
                o = e.split("/"), a = o.length;
                e: for (; a > 0; a -= 1) {
                    if (u = o.slice(0, a).join("/"), t)
                        for (s = t.length; s > 0; s -= 1)
        ...
        function d(e, t, i, o) {
            var a, u, d = null,
                ...
                p = !0,
                l = "";
            return e || (p = !1, e = "_@r" + (J += 1)), e = s(e), d = e[0], e = e[1], d && (d = r(d, c, o), u = n(F, d)), e && (d ? l = u && u.normalize ? u.normalize(e, function(e) {
                return r(e, c, o)
            }) : -1 === e.indexOf("!") ? r(e, c, o) : e : (l = r(e, c, o), e = s(l), d = e[0], l = e[1], i = !0, a = k.nameToUrl(l))), i = !d || u || i ? "" : "_unnormalized" + (P += 1), {
                prefix: d,
                name: l,
                parentMap: t,
                unnormalized: !!i,
        ...
        function f(e, i, r) {
            var o = e.id,
                a = n(w, o);
            !t(F, o) || a && !a.defineEmitComplete ? (a = c(e), a.error && "error" === i ? r(a.error) : a.on(i, r)) : "defined" === i && r(F[o])
        }
        ...
        function g() {
            var e, t, i = (e = 1e3 * D.waitSeconds) && k.startTime + e < (new Date).getTime(),
                ...
                u = !0;
            if (!E) {
                if (E = !0, A(C, function(e) {
                        var d = e.map,
                            c = d.id;
                        if (e.enabled && (d.isDefine || r.push(e), !e.error))
                            if (!e.inited && i) a(c) ? s = t = !0 : (n.push(c), o(c));
                            else if (!e.inited && e.fetched && d.isDefine && (s = !0, !d.prefix)) return u = !1
                    }), i && n.length) return e = B("timeout", "Load timeout for modules: " + n, null, n), e.contextName = k.contextName, p(e);
                u && v(r, function(e) {
                    m(e, {}, {})
        ...
        function y() {
            var e;
            for (l(); O.length;) {
                if (e = O.shift(), null === e[0]) return p(B("mismatch", "Mismatched anonymous define() module: " + e[e.length - 1]));
                x(e)
            }
            k.defQueueMap = {}
        }
        ...
        return j = {
            ...
            exports: function(e) {
                return e.usingExports = !0, e.map.isDefine ? e.exports ? F[e.map.id] = e.exports : e.exports = F[e.map.id] = {} : void 0
            },
            module: function(e) {
            ...
            callPlugin: function() {
                ...
                this.depMaps.push(a), f(a, "defined", u(this, function(a) {
                    ...
                    this.map.unnormalized ? (a.normalize && (m = a.normalize(m, function(e) {
                        return r(e, g, !0)
                    }) || ""), a = d(i.prefix + "!" + m, this.map.parentMap), f(a, "defined", u(this, function(e) {
                        this.init([], function() {
                            return e
                        }, null, {
                            enabled: !0,
                        ...
                        try {
                            ...
                            return p(B("fromtexteval", "fromText eval for " + o + " failed: " + l, l, [o]))
                        }
            ...
            configure: function(e) {
                ...
                A(e, function(e, t) {
                    ...
                    t = e.name, e.location && (D.paths[t] = e.location), D.pkgs[t] = e.name + "/" + (e.main || "main").replace(ha, "").replace(Q, "")
                }), A(w, function(e, t) {
            ...
            makeRequire: function(a, s) {
                function u(n, r, o) {
                    var f, l;
                    return s.enableBuildCallback && r && G(r) && (r.__requireJsBuild = !0), "string" == typeof n ? G(r) ? p(B("requireargs", "Invalid require call"), o) : a && t(j, n) ? j[n](w[a.id]) : e.get ? e.get(k, n, a, u) : (f = d(n, a, !1, !0), f = f.id, t(F, f) ? F[f] : p(B("notloaded", 'Module name "' + f + '" has not been loaded yet for context: ' + i + (a ? "" : ". Use require([])")))) : (y(), k.nextTick(function() {
                        y(), l = c(d(null, a)), l.skipMap = s.skipMap, l.init(n, r, o, {
                            enabled: !0
                        }), g()
                    }), u)
                }
                return s = s || {}, U(u, {
                    ...
                    toUrl: function(e) {
                        var t, i = e.lastIndexOf("."),
                            n = e.split("/")[0];
                        return -1 !== i && ("." !== n && ".." !== n || i > 1) && (t = e.substring(i, e.length), e = e.substring(0, i)), k.nameToUrl(r(e, a && a.id, !0), t, !0)
                    },
                    defined: function(e) {
            ...
            nameToUrl: function(t, i, r) {
                var o, a, s;
                if ((o = n(D.pkgs, t)) && (t = o), o = n(_, t)) return k.nameToUrl(o, i, r);
                if (e.jsExtRegExp.test(t)) o = t + (i || "");
                else {
                    for (o = D.paths, t = t.split("/"), a = t.length; a > 0; a -= 1)
                        if (s = t.slice(0, a).join("/"), s = n(o, s)) {
                            H(s) && (s = s[0]), t.splice(0, a, s);
                            break
                        }
                    o = t.join("/"), o += i || (/^data\:|\?/.test(o) || r ? "" : ".js"), o = ("/" === o.charAt(0) || o.match(/^[\w\+\.\-]+:/) ? "" : D.baseUrl) + o
                }
            ...
            onScriptError: function(e) {
                var t = b(e);
                return a(t.id) ? void 0 : p(B("scripterror", "Script error for: " + t.id, e, [t.id]))
            }
        }, k.require = k.makeRequire(), k
    }
    var e, x, y, D, I, E, N, J, r, O, ja = /(\/\*([\s\S]*?)\*\/|([^:]|^)\/\/(.*)$)/gm,
    ...
    if ("undefined" == typeof define) {
        ...
        "undefined" != typeof require && !G(require) && (s = require, require = void 0), e = requirejs = function(t, i, r, o) {
            var a, s = "_";
            ...
            e()
        }, require || (require = e), e.version = "2.1.20", e.jsExtRegExp = /^\/|:|\?|\.js$/, e.isBrowser = z, x = e.s = {
            contexts: F,
            newContext: ga
            ...
            if (ea) try {
                ...
                t.onError(B("importscripts", "importScripts failed for " + i + " at " + n, a, [i]))
            }
        }, z && !s.skipDataMain && T(document.getElementsByTagName("script"), function(t) {
            return y || (y = t.parentNode), (I = t.getAttribute("data-main")) ? (r = I, s.baseUrl || (E = r.split("/"), r = E.pop(), O = E.length ? E.join("/") + "/" : "./", s.baseUrl = O), r = r.replace(Q, ""), e.jsExtRegExp.test(r) && (r = I), s.deps = s.deps ? s.deps.concat(r) : [r], !0) : void 0
