$(document).ready(function() {
	var $contact_firstname, $contact_lastname, $contact_phone, $contact_email, $contact_message, $btnSend, form_errors, data, service_url;
	...
	$.submit_contact_form = function() {
		...
		if ( !$.validate_input( $contact_firstname )) {
			form_errors++;
