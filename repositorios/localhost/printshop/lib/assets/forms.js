...
/*function formLogIn(form, email, password) {
    var p, dataElement, logged, full;
    
    form = $('form#process_login');
    email = $('#inputEmail').val();
    password = $('#inputPassword').val();

    console.log('entra form login');
    ...
    CAMIN.appendMulti(form, dateElement);

    full = (email, password) ? true : false;

    if ( !full ) {
        swal({   title: "Oops...",   text: "Todos los datos son requeridos",   type: "error",   confirmButtonText: "Aceptar" });
    }
