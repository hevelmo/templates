$(document).ready( function() {
    ...
    bubble   = new _bubble([ {
            'text': 'Los autos Suzuki son hechos en Japón, símbolo de alta calidad de manufactura.',
            'class': 'alert-suzuki',
            'url': '/razones#razon-2'
        }, {
            ...
            'text': 'El precio de mantenimiento de los autos Suzuki es menor a $292 al mes.',
            'class': 'alert-suzuki',
            'url': '/razones#razon-5'
        }, {
    ...
    var no_open = ['instantdrive','razones'],
        current_url = ( window.location.pathname.split('index.html') )[1];
