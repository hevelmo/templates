...
<head>
<title>Library archive software OCR image zoom</title>
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<meta http-equiv="imagetoolbar" content="no">

<meta property="og:type" content="article"/>
<meta property="og:title" content="Library archive software OCR image zoom"/>
<meta property="og:description" content="Loads a set of images, e.g. an old book or newspaper and allowes to search keywords, visually highlight the results and zoom to these hotspots."/>
<meta name="description" content="Loads a set of images, e.g. an old book or newspaper and allowes to search keywords, visually highlight the results and zoom to these hotspots." />
<meta property="og:image" content="http://www.ajax-zoom.com/pic/layout/image-zoom_34.jpg"/>

<?php
if (strpos($_SERVER['HTTP_USER_AGENT'],"iPhone")){
	echo "<meta name=\"viewport\" content=\"width=device-width,  minimum-scale=0.6, maximum-scale=0.6, user-scalable=no\">";
}else{
...
<div id="nav">
	...
	<div id="hotspotCoordParent" style="color: #FFFFFF; position: relative;">
		...
		<div id="someTextLeft">
			...
			<a href="http://en.wikipedia.org/wiki/Tesseract_%28software%29" rel="nofollow" target="_blank">tesseract-ocr</a> sofware 
			...
			<p>At <a href="http://www.ajax-zoom.com/examples/example34.php" target="_blank">ajax-zoom.com</a> 
			...
			On <a href="http://www.ajax-zoom.com/index.php?cid=contact" target="_blank">request</a> 
...
jQuery(document).ready(function($){
	...
	// ALTO: http://schema.ccs-gmbh.com/ALTO, http://www.loc.gov/ndnp/alto_1-1-041.xsd
