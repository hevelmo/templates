$(document).ready(function () {       
    ...
    setTimeout(function(){
        $('.footer-menu .menu-item').addClass('remove-menu');
    ...
    $('.footer-menu-open').click(function(){
        $('.footer-submenu-open, .footer-submenu-close, .footer-menu-share').addClass('active-submenu-button');
        $('.footer-submenu-open, .footer-submenu-close, .footer-menu-open, .footer-menu-share').addClass('remove-menu');
        ...
        $($('.page-menu .footer-menu .menu-item').get().reverse()).each(function(i){
            var row = $(this);
            setTimeout(function() {
    ...
    $('.footer-menu-close, .footer-menu-tap-close').click(function(){
        $('.footer-submenu-open, .footer-submenu-close, .footer-menu-share').removeClass('active-submenu-button');
        $('.footer-submenu-open, .footer-menu-open, .footer-menu-share').removeClass('remove-menu');
        $('.footer-menu-close, .footer-menu-tap-close').addClass('remove-menu');
        $('.share-bottom-tap-close').removeClass('share-bottom-tap-close-active');
        $('.share-bottom').removeClass('active-share-bottom'); 
        $('.page-menu .footer-menu .menu-item').each(function(i){
            var row = $(this);
            setTimeout(function() {
                row.toggleClass('remove-menu');
            }, 20*i);
        });
        var numItems = $('.page-menu .footer-menu .menu-item').length
        setTimeout(function() {
    ...
    //Activate SubMenu
    $('.footer-submenu-open').click(function(){
        $('.footer-submenu-open, .footer-submenu-close, .footer-menu-share').addClass('active-submenu-button');
        $('.footer-menu-open, .footer-menu-close, .footer-submenu-open, .footer-menu-share').addClass('remove-menu');
        $('.page-submenu, .footer-menu-background, .footer-submenu-tap-close, .footer-submenu-close').removeClass('remove-menu');
        $('.share-bottom-tap-close').removeClass('share-bottom-tap-close-active');
        $('.share-bottom').removeClass('active-share-bottom'); 
        $('.page-submenu .footer-menu-wrapper').removeClass('remove-wrapper');
        $($('.page-submenu .footer-menu .menu-item').get().reverse()).each(function(i){
            var row = $(this);
            setTimeout(function() {
                row.toggleClass('remove-menu');
            }, 20*i);
    ...
    $('.footer-submenu-close, .footer-submenu-tap-close').click(function(){
        $('.footer-submenu-open, .footer-submenu-close, .footer-menu-share').removeClass('active-submenu-button');  
        $('.footer-menu-open, .footer-submenu-open, .footer-menu-share').removeClass('remove-menu');
        $('.footer-submenu-close, .footer-submenu-tap-close').addClass('remove-menu');
        $('.share-bottom-tap-close').removeClass('share-bottom-tap-close-active');
        $('.share-bottom').removeClass('active-share-bottom'); 
        $('.page-submenu .footer-menu .menu-item').each(function(i){
            var row = $(this);
            setTimeout(function() {
                row.toggleClass('remove-menu');
            }, 20*i);
        });
        var numItems = $('.page-submenu .footer-menu .menu-item').length
        setTimeout(function() {
            $('.footer-menu-background').addClass('remove-menu');
            $('.footer-menu-wrapper').addClass('remove-wrapper');
            $('.page-page-submenu').addClass('remove-menu');
        }, numItems*20); //-50
    ...
    if($('body').hasClass('has-cover')){
        ...
        function calculate_covers(){
            ...
            $('.cover-page').css('height', screen_height -70);
            ...
            $('.cover-screen').css('height', cover_height - 70);
