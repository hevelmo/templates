...
$(document).ready(function(){
    ...
    var current_menu = '',
        ...
        sections_positions = [],
        yy = 0,
        arrow_section = [ 0, -403, -330, -165, -30, 125, 280 ],
    ...
    if( current_car.key === 's-cross'){
        var badges_html =
            '<a class="popoverbox" href="#" data-target="#master_test"  id="master_test_trigger" ><span>&nbsp;</span></a>' +
            '<a class="popoverbox" href="#" data-target="#auto_show_tv" id="auto_show_tv_trigger"><span>&nbsp;</span></a>';
        $body.append( badges_html );
