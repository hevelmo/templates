/*
    ...
    model and its arguments, for example CORE.momentToHuman(date, language);
    Each method has a large explanation.

    NOTE: the prefix CORE will change depends on the specific Project.
...
AUD = (function() {
    ...
    */
        ...
        **/
        ...
        /*
         *This function deletes all "new lines" (\n) and "carriages return".
         *
         *PARAMS:
         *   string: The string with the original value.
         *
        ...
        **/
            function linealString(string) {
                ...
                newString = newString.split("\r").join(" ");
                newString = advancedTrim(newString);
                return newString;
            }  
    /*
     ###################################################################################################
