...
$(document).ready(function() {
    ...
    $.test_drive_promo_s_cross = function(form) {
        ...
        if (form_errors === 0) {
            ...
            analytics_test_drive('S-Cross_home', 0.071 * precio_actual, 's-cross_Home');
    ...
    if (IS_MOBILE) {
        ...
        //
        $('.scross_bg[alt="Ciaz"]').attr('src', '/autos/images/sections/home/s-cross/car-mobile.jpg').width($(window).width());


        $video_home_cross.remove();
        //$("#slider-car4, #home-scross, .section-title.hide_s-cross").remove();
        //$("#menu-cars-home").prepend('<div id="slider-car4" class="item car-4"><div class="slider-car-sprite"></div><a href="/autos/s-cross"><h3>S-Cross</h3></a></div>');
    }
    ...
    var feed = new Instafeed({
        ...
        userId: 26745515,
        links: false,
        accessToken: '26745515.cf0499d.b20eb8ced45e451181571a24163f517a',
